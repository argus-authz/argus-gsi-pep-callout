...
[
    ...
    GLOBUS_GSS_NOTHR_LIBS="$ac_globus_ldlib -lglobus_gssapi_gsi_$with_globus_nothr_flavor -lgssapi_error_$with_globus_nothr_flavor -lglobus_gss_assist_$with_globus_nothr_flavor"
    GLOBUS_GSS_THR_LIBS="$ac_globus_ldlib -lglobus_gssapi_gsi_$with_globus_thr_flavor -lgssapi_error_$with_globus_nothr_flavor -lglobus_gss_assist_$with_globus_thr_flavor"
    ...
    AC_SUBST(GLOBUS_GSI_NOTHR_LIBS)
    AC_SUBST(GLOBUS_GSI_THR_LIBS)
    AC_SUBST(GLOBUS_LDAP_THR_LIBS)

    AC_MSG_NOTICE([GLOBUS_LOCATION= $GLOBUS_LOCATION])
    AC_MSG_NOTICE([GLOBUS_NOTHR_FLAVOR= $GLOBUS_NOTHR_FLAVOR])
    AC_MSG_NOTICE([GLOBUS_NOTHR_CFLAGS= $GLOBUS_NOTHR_CFLAGS])
    AC_MSG_NOTICE([GLOBUS_NOTHR_LDLAGS= $GLOBUS_NOTHR_LDCFLAGS])
    AC_MSG_NOTICE([GLOBUS_COMMON_NOTHR_LIBS= $GLOBUS_COMMON_NOTHR_LIBS])
    AC_MSG_NOTICE([GLOBUS_GSS_NOTHR_LIBS= $GLOBUS_GSS_NOTHR_LIBS])
    AC_MSG_NOTICE([GLOBUS_GSI_NOTHR_LIBS= $GLOBUS_GSI_NOTHR_LIBS])
